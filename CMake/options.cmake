...
if(FLTK_USE_SYSTEM_ZLIB)
  ...
  if(NOT ZLIB_FOUND)
    ...
    get_target_property(LIB_zlib ZLIB::ZLIB IMPORTED_LOCATION)
    if (NOT LIB_zlib)
...
if(FLTK_USE_SYSTEM_LIBPNG AND NOT FLTK_USE_BUNDLED_ZLIB)
  ...
  if(NOT PNG_FOUND)
    ...
    get_target_property(LIB_png PNG::PNG IMPORTED_LOCATION)
    if (NOT LIB_png)
...
if(FLTK_USE_SYSTEM_LIBJPEG)
  ...
  if(NOT JPEG_FOUND)
    ...
    get_target_property(LIB_jpeg JPEG::JPEG IMPORTED_LOCATION)
    if (NOT LIB_jpeg)
