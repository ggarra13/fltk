...
/**
  \file Fl_Vulkan_Graphics_Driver_vertex.cxx
  \brief  Portable drawing code for drawing arbitrary shapes with
          simple 2D transformations, implemented for Vulkan.
*/
...
// Vulkan does not support rednering non-convex polygons. Calling
// vkBegin(VK_POLYGON); witha  complex outline will create rather random
...
void Fl_Vulkan_Graphics_Driver::end_points() {
  vkEnd();
}
...
void Fl_Vulkan_Graphics_Driver::end_line() {
  vkEnd();
}
...
void Fl_Vulkan_Graphics_Driver::end_loop() {
  vkEnd();
}
...
void Fl_Vulkan_Graphics_Driver::end_polygon() {
  vkEnd();
}

void Fl_Vulkan_Graphics_Driver::begin_complex_polygon() {
  n = 0;
...
// use vkuTess* functions to do this; search for vkuBeginPolygon
void Fl_Vulkan_Graphics_Driver::end_complex_polygon() {
  vkEnd();
}
