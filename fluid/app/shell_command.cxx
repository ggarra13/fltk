...
// TODO: add @APPDIR@?
// TODO: add a bunch of sensible sample shell commands, add to 'import' pulldown menu
//      1: Build generated app
//          Runs the project’s normal build command after saving the .fl file and
//          generated sources. This is the baseline action and should work with
//          the user’s preferred toolchain, for example make, ninja, or a wrapper
//          script in the project directory.
//      2: Run generated app
//          Launches the compiled executable immediately after a successful build.
//          This is the fastest edit-build-run loop and is probably the most-used
//          action in practice.
//      3: Build and run
//      4: Open project in IDE
//      5: Reveal generated files in Explorer/Finder
//      6: Diff generated code against working tree
