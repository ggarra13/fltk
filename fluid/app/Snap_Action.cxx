...
static bool in_group(Snap_Data &d) {
  return (d.wgt && d.wgt->parent && dynamic_cast<Group_Node*>(d.wgt->parent) && d.wgt->parent != d.win);
}

static bool in_tabs(Snap_Data &d) {
  return (d.wgt && d.wgt->parent && dynamic_cast<Tabs_Node*>(d.wgt->parent));
}
...
public:
  ...
  void check(Snap_Data &d) override {
    ...
    best_match = nullptr;
    if (!d.wgt) return;
    if (!dynamic_cast<Group_Node*>(d.wgt->parent)) return;
    int dsib_min = 1024;
